...
public class PlayFellowMemberController {
	...
	@GetMapping("/playFellow/memId/{memId}")
	...
	//add伴遊者資料
    @PostMapping("/playFellow/add")
	public String AddPlayFellowMember(@ModelAttribute("members")Member member,@ModelAttribute("playFellowMember")PlayFellowMember playFellowMember) {
