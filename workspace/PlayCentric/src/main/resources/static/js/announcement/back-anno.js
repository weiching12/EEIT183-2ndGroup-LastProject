    ...
    tbody.innerHTML += `
        <tr>
            <td class="border p-3 title">
                <a href="/PlayCentric/anno/showOneAnno?annoId=${data.annoId}" class="text-center">${data.title}</a>
            </td>
            <td class="border p-3 title text-center">${data.announcementType.annoTypeName}</td>
            ...
            <td class="text-center border p-3">
                <a href="/PlayCentric/anno/getUpdatAnno?annoId=${data.annoId}" class="btn btn-sky rounded-md me-2 block md:inline">修改</a>
                <a href="/PlayCentric/anno/deleteAnno?annoId=${data.annoId}" class="btn btn-danger rounded-md me-2 block md:inline">刪除</a>
            </td>
        </tr>
    `;
}
